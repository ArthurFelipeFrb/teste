...
public class LoginController {
    ...
    public ResponseEntity<?> processLogin(@RequestBody Funcionario funcionario) {
        Optional<FuncionarioDTO> userDTO = funcionarioService.autenticar(funcionario.getUsername(), funcionario.getPassword()); // Retorna DTO
    ...
    public ResponseEntity<String> logout() {
        return ResponseEntity.ok("Deslogado com sucesso (apenas informativo, a lógica de token deve ser no frontend).");
    }
}